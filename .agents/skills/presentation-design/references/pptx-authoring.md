...
Если после PPTX-проверки меняешь HTML, общие стили, изображения или размеры блоков, во время итерации можно проверить затронутые слайды. Перед финальной сдачей снова экспортируй PNG и обнови `exports/slide-qa.md` до полного чистого прохода.
