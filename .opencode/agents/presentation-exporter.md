...
Используй compact task packet от главного агента и role-specific справочники: `.agents/skills/presentation-design/SKILL.md`, `html-decks.md`, `pptx-authoring.md` и `presentation-svg.md`, когда они уместны. Не читай весь проект и не запускай других субагентов.

Ты не выбираешь общий маршрут и не включаешь полный multi-agent процесс. В fast path тебя обычно не запускают: локальные export scripts являются достаточным deterministic механизмом.
